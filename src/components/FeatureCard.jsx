...
const FeatureCard = () => {
    ...
    return (
        <div className='flex  flex-col justify-center h-full py-4 md:py-8'>
            ...
            <div className='w-full h-full font-libre px-8 py-4   flex flex-col justify-center items-center'>

                <h1 className='text-xl text-[#A1347E] py-8 mt-12 font-bold'>How to Create Free Marriage Biodata - A Detailed Guide</h1>
                <div className='flex w-full justify-between  px-8  gap-12 '>
                    <div className='w-1/2'>
                        <img src={ biotemp } alt="img" />
                    </div>
